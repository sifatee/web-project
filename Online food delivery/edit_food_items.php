...
<html>
  ...
  <head>
    <title> Manager Login | Panda Delivery' </title>
  </head>
 ...
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="dprice" name="dprice" value=<?php echo $row1['price'];  ?> placeholder="Your Food Price (BDT)" required="">
          </div>
